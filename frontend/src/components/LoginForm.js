...
//             if (response.ok) {
//                 setErrorMessage('');
//                 // Make sure to correctly access studentId in the response
//                 if (role === 'student') {
//                     navigate('/student-dashboard', { state: { studentId: data.studentId } }); // Pass the student ID
//                 } else if (role === 'teacher') {
//                     navigate('/teacher-dashboard', { state: { teacherId: data.teacherId, teacherName: data.userName } });
//                 } else if (role === 'admin') {
...
//             if (response.ok) {
//                 setErrorMessage('');
//                 // Pass the student ID correctly
//                 if (role === 'student') {
//                     navigate('/student-dashboard', { state: { studentId: data.studentId } }); // Pass the student ID
//                 } else if (role === 'teacher') {
//                     navigate('/teacher-dashboard', { state: { teacherId: data.teacherId } });
//                 } else if (role === 'admin') {
//                     navigate('/admin-dashboard');
//                 }
//             } else {
